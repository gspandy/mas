...
import com.letv.mas.caller.iptv.tvproxy.common.model.dto.response.BossTpResponse;
import com.letv.mas.caller.iptv.tvproxy.common.model.dto.response.UserBindTpResponse;
...
@Component
public class VipTpDaoBak extends BaseTpDao {

    private final static Logger LOG = LoggerFactory.getLogger(VipTpDaoBak.class);
