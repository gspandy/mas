 ...
 * 短信报警是否成功Response
 */
public class AlarmSMSResponse implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -2948446125038855388L;
    ...
    public String toString() {
        return "AlarmSMSResponse [status=" + status + ", data=" + data + ", code=" + code + ", msg=" + msg + "]";
    }
