...
public class LiveSDKDto implements Serializable {
    private static final long serialVersionUID = 7507885546559215270L;
    private List<LiveSDK> projects = new ArrayList<LiveSDK>();
    ...
    public LiveSDKDto(List<LiveSDK> projects, String bgImg, String title) {
    ...
    public List<LiveSDK> getProjects() {
        return this.projects;
    }

    public void setProjects(List<LiveSDK> projects) {
        this.projects = projects;
        this.size = projects == null ? 0 : projects.size();
    }
