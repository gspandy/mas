 ...
 * 语音报警是否成功Response
 */
public class AlarmVoiceResponse implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -2948446125038855383L;
    ...
    public String toString() {
        return "AlarmVoiceResponse [status=" + status + ", data=" + data + ", code=" + code + ", msg=" + msg + "]";
    }
