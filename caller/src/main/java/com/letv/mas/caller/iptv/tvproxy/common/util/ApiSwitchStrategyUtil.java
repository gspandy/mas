 ...
 * }
 */
public class ApiSwitchStrategyUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ApiSwitchStrategyUtil.getUrlTemp(url1));
        System.out.println(ApiSwitchStrategyUtil.getUrlTemp(url2));
        System.out.println(ApiSwitchStrategyUtil.getUrlTemp(url3));
        System.out.println(ApiSwitchStrategyUtil.getUrlTemp(url4));
        System.out.println(ApiSwitchStrategyUtil.getUrlTemp(url5));
        System.out.println(ApiSwitchStrategyUtil.getUrlTemp(url6));
    }
}
