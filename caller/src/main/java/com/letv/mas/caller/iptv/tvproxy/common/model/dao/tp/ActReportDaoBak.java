...
@Component
public class ActReportDaoBak extends BaseTpDao {

    // refer: http://wiki.letv.cn/pages/viewpage.action?pageId=70590725
    private final static Logger log = LoggerFactory.getLogger(ActReportDaoBak.class);
    ...
    private String getUriAntiReport(){
        return ApplicationUtils.get(ApplicationConstants.ACT_REPORT_ANTI_SET_URI);
    }
    ...
    private String getUriAntiOpt(){
        return ApplicationUtils.get(ApplicationConstants.ACT_REPORT_ANTI_OPT_URI);
    }
    // 删除key，ttl可不传
