...
import com.letv.mas.caller.iptv.tvproxy.apicommon.model.dto.NewBaseResponse;
...
public class ErrorCodeCommonUtil {
     ...
     * @return
     */
    public static NewBaseResponse setErrorResponse(NewBaseResponse response, String errorCode, String langcode) {
        if (response != null) {
            response.setStatus(NewBaseResponse.STATUS_ERROR);
            response.setErrorCode(errorCode);
            response.setErrorMessage(MessageUtils.getMessage(errorCode, langcode));
        }
        return response;
    }
     ...
     * @return
     */
    public static NewBaseResponse setErrorResponse(NewBaseResponse response, String errorCode, String errorMsgCode,
            String langcode) {
        if (response != null) {
            response.setStatus(NewBaseResponse.STATUS_ERROR);
            response.setErrorCode(errorCode);
            String message = MessageUtils.getMessage(errorMsgCode, langcode);
            if (StringUtil.isBlank(message)) {
                message = MessageUtils.getMessage(errorCode, langcode);
            }
     ...
     * @return
     */
    public static NewBaseResponse setErrorResponse(NewBaseResponse response, Integer status, String errorCode,
            String langcode) {
        if (response != null) {
     ...
     */
    public static NewBaseResponse setErrorResponse(NewBaseResponse response, Integer status, String errorCode,
            String errorMsgCode, String langcode) {
        if (response != null) {
            response.setStatus(status);
            response.setErrorCode(errorCode);
            String message = MessageUtils.getMessage(errorMsgCode, langcode);
