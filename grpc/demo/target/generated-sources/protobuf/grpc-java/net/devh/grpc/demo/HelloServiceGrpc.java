...
public final class HelloServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<net.devh.grpc.demo.HelloRequest,
      net.devh.grpc.demo.HelloResponse> METHOD_SAY_HELLO = getSayHelloMethodHelper();

  private static volatile io.grpc.MethodDescriptor<net.devh.grpc.demo.HelloRequest,
      net.devh.grpc.demo.HelloResponse> getSayHelloMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<net.devh.grpc.demo.HelloRequest,
      net.devh.grpc.demo.HelloResponse> getSayHelloMethod() {
    return getSayHelloMethodHelper();
  }

  private static io.grpc.MethodDescriptor<net.devh.grpc.demo.HelloRequest,
      net.devh.grpc.demo.HelloResponse> getSayHelloMethodHelper() {
    io.grpc.MethodDescriptor<net.devh.grpc.demo.HelloRequest, net.devh.grpc.demo.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<net.devh.grpc.demo.HelloRequest, net.devh.grpc.demo.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "HelloService", "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.devh.grpc.demo.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.devh.grpc.demo.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(net.devh.grpc.demo.HelloRequest request,
        io.grpc.stub.StreamObserver<net.devh.grpc.demo.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                net.devh.grpc.demo.HelloRequest,
                net.devh.grpc.demo.HelloResponse>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
     ...
     * </pre>
     */
    public net.devh.grpc.demo.HelloResponse sayHello(net.devh.grpc.demo.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<net.devh.grpc.demo.HelloResponse> sayHello(
        net.devh.grpc.demo.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((net.devh.grpc.demo.HelloRequest) request,
              (io.grpc.stub.StreamObserver<net.devh.grpc.demo.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return net.devh.grpc.demo.HelloProto.getDescriptor();
    }
